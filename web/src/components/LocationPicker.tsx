 ...
 */
export default function LocationPicker({ value, onChange, productId, exclude = [], alsoHighlight = [], label = "已選" }: Props) {
  ...
  return (
    <div className="space-y-3">
      <LocationSelect value={value} onChange={(l) => { setHint(null); onChange(l); }} productId={productId} exclude={exclude} />
