...
| | |
|---|---|
| 線上系統 | [https://zhunan-cold-storage.liao950715.workers.dev/](https://zhunan-cold-storage.liao950715.workers.dev/floorplan) — 第一次開啟需輸入同步碼（向管理員取得）；示範帳號 `admin/admin1234`、`staff/staff1234` |
